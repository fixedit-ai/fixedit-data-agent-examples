...
flowchart TD
    ...
    C5 -.->|detection_frame_with_duration| D1["OPTIONAL<br/>config_output_time_in_area.conf:<br/>Send metrics to InfluxDB"]
    ...
    style D1 fill:#ffebee,stroke:#e53935,stroke-dasharray: 5 5
